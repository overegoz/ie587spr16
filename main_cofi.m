...
%  Once your cost function matches up with the precalculated result, 
...
%  Once your cost matches up with the precalculated result, 
%  you should proceed to implement 
