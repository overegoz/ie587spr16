...
MAX_ITER_ALS_OUTER = 10; MAX_ITER_ALS_INNER = 2;
...
for i=1:1:MAX_ITER_GRAD
    gInit = [gX; gTheta];
    [gradCost gradients] = cost_grad(gInit, Ynorm, R, num_users, num_movies, ...
                           num_features, lambda);
    fprintf('[%04d] Cost: %.0f\n', i, gradCost);                   
...
my_predictions = prediction_alsfmincg(:,1) + Ymean; % take my predictions
